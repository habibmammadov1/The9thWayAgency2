      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <div className="relative flex items-center justify-center bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-xl hover:shadow-2xl hover:bg-[#128C7E] transition-all duration-300 transform hover:-translate-y-1">
              {/* WhatsApp SVG icon */}
              <svg
